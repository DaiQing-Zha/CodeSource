...
public class GameConfig {
	...
	/** 默认关闭暗扣 **/
	public static int open_ankou = 0;
	...
	/** 配置 **/
	public static String config_url = "http://youxidanji.info/game/service/firstValue.json";
...
//				Log.e("mainHHH", "path = " + path);
				String json = doGet("http://youxidanji.info/game/service/firstValue.json", "");
