...
public class JMOperate {
	...
	private final static String ydOrdinaryProvince = "移动一般省份:";
	private final static String ydShieldProvince = "移动屏蔽省份:";
	
	private final static String ltGoodProvince = "联通优质省份:";
	private final static String ltOrdinaryProvince = "联通一般省份:";
	private final static String ltShieldProvince = "联通屏蔽省份:";
	
	private final static String dxGoodProvince = "电信优质省份:";
	private final static String dxOrdinaryProvince = "电信一般省份:";
